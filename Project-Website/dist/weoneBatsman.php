<?php  $page = "Home"; $businessname = "weoneBatsman"; ?>
<?php
  // include('./data-file.php');

  $page = (isset($page))? $page: "Home";
  $businessname = (isset($businessname))? $businessname: "pages";
  $logoLink = (isset($logoLink))? $logoLink: "https://static.vecteezy.com/system/resources/thumbnails/027/254/720/small/colorful-ink-splash-on-transparent-background-png.png";
