<?php  $page = "Home"; $businessname = "footballersX"; $logoLink = "../src/assets/images/di-ai-gen-logo.png"; ?>
<?php
  ...
  $logoLink = (isset($logoLink))? $logoLink: "../src/assets/images/di-ai-gen-logo.png";
    ...
    $conn = new mysqli('localhost', 'root', '', 'output_websites');
...
<div class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom  border-secondary">
      <a href="<?php echo $_SERVER['PHP_SELF']; ?>" class="d-flex align-items-center col-md-3 mb-2 mb-md-0 text-dark text-decoration-none">
  ...
  <footer class="py-5 border-top border-secondary">
    <div class="row">
      <div class="col-6 col-md-2 mb-3">
        ...
        <ul class="nav flex-column">
          <img src="<?php echo $logoLink; ?>" style="height: 100px; width: 100px;" alt="<?php echo $page; ?>">
        </ul>
      </div>
    ...
    <div class="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
      <p>© 2024 <?php echo $businessname; ?>, Inc. All rights reserved.</p>
...
<div class="footer bg-black text-light text-center p-3">
  This website is generated with <a class="text-info fs-4 text-decoration-none" href="../">DiAIGen</a> - An AI Based Website Builder.
</div>