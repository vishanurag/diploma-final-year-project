<?php
    $page = "home";
    $businessname = "BusinessOne";
    $logoLink = "https://static.vecteezy.com/system/resources/thumbnails/027/254/720/small/colorful-ink-splash-on-transparent-background-png.png";
?>
<?php
  // include('./data-file.php');
    ...
    $q = "SELECT * FROM `pages` WHERE `page_id` = '".$page."';";
