<?php  $page = "Home"; $businessname = "bestoutofwaste"; $logoLink = "../src/assets/images/di-ai-gen-logo.png"; ?><?php
...
<section id="<?php echo $row['page_id']; ?>">
    <div class="container hero-section  d-flex justify-content-between align-items-center" id="section1">
...
</html><div class="footer bg-black text-light text-center p-3">
